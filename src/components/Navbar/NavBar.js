...
const NavBar = () => {
    ...
    return (
        <nav className={`bg-white fixed top-0 w-full z-30 transition duration-300 ease-in-out mb-16 ${!top && 'bg-white'}`}
            style={!top ? { boxShadow: '0 4px 6px rgba(5, 60, 20, 0.2)' } : {}}>
            <div className="flex flex-row justify-between items-center py-2">
                <div className="flex flex-row justify-center md:px-12 md:mx-12 items-center text-center font-semibold">
                    <HashLink smooth to="/#home"><h1 className="font-extrabold text-4xl text-green-600">BizPoints</h1></HashLink>
